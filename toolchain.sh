...
apt update
apt -y install autoconf unzip automake bison libelf-dev flex gcc g++ libelf-dev make texinfo libncurses5-dev patch python3-dev subversion git zlib1g-dev libtool-bin python-dev-is-python3 bzip2 libgmp3-dev pkg-config libssl-dev aria2 wget xz-utils
